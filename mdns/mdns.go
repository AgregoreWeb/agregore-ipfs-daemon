...
// https://github.com/berty/berty/blob/e053901de13a6bc3a26952a57d7382fd6792a545/go/internal/ipfsutil/mdns.go
//
// Logging lines commented out, so that berty's logutil pkg doesn't need to be imported
// Code for getting interfaces changed to receive interfaces as argument
...
func (s *MdnsService) startServer() error {
	...
	ifaces := filterMulticastInterfaces(s.ifaces)
...
func GetMulticastInterfaces(s *MdnsService) []net.Interface {
	// manually get interfaces list
	// filter Multicast interfaces
	return filterMulticastInterfaces(s.ifaces)
}
